										...
										<td colspan="11" align="center">
											<ul class="pagination">
												...
												<c:if test="${paging.startPage > 10}">
													<li><a
														href="${path}/ad_product_list.pd?pageNum=${paging.prev}"
														class="prevPage"> [이전] </a></li>
												</c:if>

												<c:forEach var="num" begin="${paging.startPage}"
													end="${paging.endPage}">
													<li><a
														href="${path}/ad_product_list.pd?pageNum=${num}"
												...
												<c:if test="${paging.startPage < paging.pageCount}">
													<li><a
														href="${path}/ad_product_list.pd?pageNum=${paging.next}"
														class="nextPage"> [다음] </a></li>
												</c:if>
											</ul>
										</td>
									</tr>
